...
---------------------------------------------------------
MTSLUI_PLAYER_EXPLORER_FRAME = MTSL_TOOLS:CopyObject(MTSLUI_BASE_FRAME)

MTSLUI_PLAYER_EXPLORER_FRAME.FRAME_WIDTH_VERTICAL_SPLIT = 1272
MTSLUI_PLAYER_EXPLORER_FRAME.FRAME_HEIGHT_VERTICAL_SPLIT = 479

MTSLUI_PLAYER_EXPLORER_FRAME.FRAME_WIDTH_HORIZONTAL_SPLIT = 887
MTSLUI_PLAYER_EXPLORER_FRAME.FRAME_HEIGHT_HORIZONTAL_SPLIT = 738

---------------------------------------------------------------------------------------
-- Shows the frame
----------------------------------------------------------------------------------------
function MTSLUI_PLAYER_EXPLORER_FRAME:Show()
...
----------------------------------------------------------------------------------------------------------
function MTSLUI_PLAYER_EXPLORER_FRAME:Initialise()
    local swap_frames = {
        {
            button_text = "NPC",
    ...
    self.ui_frame = MTSLUI_TOOLS:CreateMainFrame("MTSLUI_PLAYER_EXPLORER_FRAME", "MTSLUI_PlayerFrame", self.FRAME_WIDTH_VERTICAL_SPLIT, self.FRAME_HEIGHT_VERTICAL_SPLIT, swap_frames)

    -- Create the frames inside this frame
    self:CreateCompontentFrames()
    self:LinkFrames()

    -- swap to logged in player
    self:RefreshUI()
end

function MTSLUI_PLAYER_EXPLORER_FRAME:CreateCompontentFrames()
    -- Copy & init the title frame
    self.title_frame = MTSL_TOOLS:CopyObject(MTSLUI_TITLE_FRAME)
    self.title_frame:Initialise(self.ui_frame, "Player Explorer", self.FRAME_WIDTH_VERTICAL_SPLIT - 5, self.FRAME_WIDTH_HORIZONTAL_SPLIT - 5)
    ...
    self.profession_list_frame:Initialise(self.ui_frame, "MTSLPLAYERUI_PROFESSION_LIST_FRAME")
    -- position under the filter frame
    self.profession_list_frame.ui_frame:SetPoint("BOTTOMLEFT", self.ui_frame, "BOTTOMLEFT", 3, 3)
    -- Copy & init the filter frame
    self.skill_list_filter_frame = MTSL_TOOLS:CopyObject(MTSLUI_FILTER_FRAME)
    self.skill_list_filter_frame:Initialise(self.profession_list_frame.ui_frame, "MTSLPLAYERUI_SKILL_LIST_FILTER_FRAME")
    ...
    self.skill_list_frame:Initialise(self.skill_list_filter_frame.ui_frame, "MTSLPLAYERUI_SKILL_LIST_FRAME")
    -- position under the filter frame
    ...
    self.skill_detail_frame:Initialise(self.skill_list_frame.ui_frame, "MTSLPLAYERUI_SKILL_DETAIL_FRAME")
...
function MTSLUI_PLAYER_EXPLORER_FRAME:LinkFrames()
...
----------------------------------------------------------------------------------------------------------
function MTSLUI_PLAYER_EXPLORER_FRAME:RefreshUI()
    -- refresh & auto select the first profession
    local known_professions = MTSL_LOGIC_PLAYER_NPC:GetKnownProfessionsForPlayer(MTSL_CURRENT_PLAYER.REALM, MTSL_CURRENT_PLAYER.NAME)
...
----------------------------------------------------------------------------------------------------------
function MTSLUI_PLAYER_EXPLORER_FRAME:SwapToVerticalMode()
    -- resize the frames
...
----------------------------------------------------------------------------------------------------------
function MTSLUI_PLAYER_EXPLORER_FRAME:SwapToHorizontalMode()
