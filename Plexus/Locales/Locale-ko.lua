...
L["Open Plexus's options in their own window, instead of the Interface Options window, when typing /plexus or right-clicking on the minimap icon, DataBroker icon, or layout tab."] = "인터페이스 옵션 창 대신 Grid 옵션을 열기위해 /plexus를 대화창에 입력하거나 미니맵 아이콘, DataBroker 아이콘 또는 배치 탭에 오른쪽 버튼을 클릭하세요."
L["Output Frame"] = "출력 창"
...
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "미니맵에 Plexus 아이콘을 표시합니다. 이 설정에 관계없이 DataBroker 표시 애드온이 아이콘을 숨길 수 있습니다."
...
L["Options for PlexusFrame."] = "각 유닛 창의 표시를 위한 옵션을 설정합니다."
...
L["Adjust Plexus scale."] = "Plexus의 크기를 조정합니다."
...
L["Allows mouse click through the Plexus Frame."] = "마우스 클릭이 Plexus 창을 통과하도록 허용합니다."
...
L["Click through the Plexus Frame"] = "Plexus 창을 통과하는 클릭"
...
L["Demon"] = "악마"
L["Drag this tab to move Plexus."] = "Plexus를 이동시키려면 이 탭을 드래그합니다."
L["Dragonkin"] = "용족"
L["Elemental"] = "정령"
...
L["Layouts"] = "배치"
L["Left"] = "좌측"
L["Lock Plexus to hide this tab."] = "이 탭을 숨기려면 Plexus를 잠그세요."
L["Locks/unlocks the Plexus for movement."] = "창을 잠그거나 잠금해제 합니다."
L["Not specified"] = "알 수 없음"
L["Options for PlexusLayout."] = "배치 창과 그룹 배치를 위한 옵션을 설정합니다."
L["Padding"] = "채우기"
...
L["Sets where Plexus is anchored relative to the screen."] = "Plexus의 어느 부분을 화면에 고정시킬 지 설정합니다."
L["Show a tab for dragging when Plexus is unlocked."] = "Plexus가 잠금 해제일 때 드래그 탭을 표시합니다."
...
Beginning users may wish to leave this disabled until you are more familiar with Plexus, to avoid being overwhelmed by complicated options menus.]=] ] = [=[강화 효과 및 약화 효과 상태에 대한 상세한 옵션을 표시합니다.

복잡한 옵션 메뉴가 표시되며, Plexus 설정에 익숙하지 않다면 해당 항목을 비활성화하세요.]=]
