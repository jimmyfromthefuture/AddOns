...
-- PlexusCore
L["Debugging"] = "除错中"
L["Debugging messages help developers or testers see what is happening inside Plexus in real time. Regular users should leave debugging turned off except when troubleshooting a problem for a bug report."] = "除错信息可以帮助开发者或测试者看到 Plexus 内部发生的实时状态。普通用户应在没有出错问题报告时关闭除错。"
L["Enable debugging messages for the %s module."] = "启用%s模块除错信息。"
L["General"] = "通用"
L["Module debugging menu."] = "模块除错菜单"
L["Open Plexus's options in their own window, instead of the Interface Options window, when typing /plexus or right-clicking on the minimap icon, DataBroker icon, or layout tab."] = "打开 Plexus 窗口内选项，而不是界面选项窗口，输入 /grid 或右击小地图图标，DataBroker 图标，布局标签。"
L["Output Frame"] = "输出框架"
L["Right-Click for more options."] = "右击获取更多选项。"
L["Show debugging messages in this frame."] = "在此框架显示除错信息。"
L["Show minimap icon"] = "显示迷你地图图标"
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "在小地图显示 Plexus 图标。注意，一些 DataBroker 显示插件无论是否设置可能隐藏图标。"
...
L["Options for PlexusFrame."] = "Plexus 框架选项。"
...
L["Adjust Plexus scale."] = "调整 Plexus 缩放。"
...
L["Allows mouse click through the Plexus Frame."] = "允许透过 Plexus 框架点击。"
...
L["Class colors"] = "职业颜色"
L["Click through the Plexus Frame"] = "透过 Plexus 框架点击"
L["Color for %s."] = "%s的颜色。"
...
L["Demon"] = "恶魔"
L["Drag this tab to move Plexus."] = "拖动此标签将移动 Plexus。"
L["Dragonkin"] = "龙类"
L["Elemental"] = "元素"
...
L["Layouts"] = "布局"
L["Left"] = "左侧"
L["Lock Plexus to hide this tab."] = "锁定 Plexus 将隐藏此标签。"
L["Locks/unlocks the Plexus for movement."] = "锁定/解锁 Plexus 框体来让其移动。"
L["Not specified"] = "未分类"
L["Options for PlexusLayout."] = "Plexus 布局的选项。"
L["Padding"] = "填充"
L["Party Layout"] = "小队布局"
L["Pet color"] = "宠物颜色"
L["Pet coloring"] = "宠物着色"
...
L["Sets where Plexus is anchored relative to the screen."] = "设定屏幕中 Plexus 的锚点。"
L["Show a tab for dragging when Plexus is unlocked."] = "未锁定 Plexus 时显示标签。"
...
Beginning users may wish to leave this disabled until you are more familiar with Plexus, to avoid being overwhelmed by complicated options menus.]=] ] = [=[为增益和减益状态显示高级选项。

初级用户应禁用此选项，直到您更熟悉 Plexus，以避免被复杂的菜单选项困惑。]=]
...
L["Out of Range"] = "超出范围"
L["Range"] = "范围"
L["Range check frequency"] = "范围检查频率"
L["Seconds between range checks"] = "范围检查之间的秒数"
