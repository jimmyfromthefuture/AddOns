...
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "在小地圖顯示 Plexus 圖示。注意，一些 DataBroker 顯示插件無論是否設定可能隱藏圖示。"
--[[Translation missing --]]
...
L["Options for PlexusFrame."] = "PlexusFrame 設定選項。"
...
L["Adjust Plexus scale."] = "調整 Plexus 縮放比例。"
--[[Translation missing --]]
...
L["Allows mouse click through the Plexus Frame."] = "允許透過滑鼠點擊 Plexus 框架。"
...
L["Class colors"] = "職業顏色"
L["Click through the Plexus Frame"] = "透過點擊 Plexus 框架"
L["Color for %s."] = "%s的顏色"
...
L["Demon"] = "惡魔"
L["Drag this tab to move Plexus."] = "拖動此標簽移動 Plexus。"
L["Dragonkin"] = "龍類"
L["Elemental"] = "元素生物"
...
L["Layouts"] = "Layouts"
L["Left"] = "左"
L["Lock Plexus to hide this tab."] = "鎖定 Plexus 隱藏此標簽。"
L["Locks/unlocks the Plexus for movement."] = "鎖定/解鎖 Plexus 框架。"
L["Not specified"] = "未指定"
L["Options for PlexusLayout."] = "Plexus版面設定選項。"
L["Padding"] = "間距"
...
L["Sets where Plexus is anchored relative to the screen."] = "設定 Plexus 的版面位置錨點。"
L["Show a tab for dragging when Plexus is unlocked."] = "當未鎖定 Plexus 時顯示標簽。"
--[[Translation missing --]]
