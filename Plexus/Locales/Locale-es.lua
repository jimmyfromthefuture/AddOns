...
L["Open Plexus's options in their own window, instead of the Interface Options window, when typing /plexus or right-clicking on the minimap icon, DataBroker icon, or layout tab."] = "Mostrar las opciones de Plexus en su propia ventana, en lugar de la ventana estándar de Opciones de interfaz, cuando se introduce el comando /grid o se hace clic en el icono de minimapa, el icono de DataBroker o la pestaña de los marcos de Grid."
...
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "Muestra el icono de Grid en la minimapa. Nota que es posible que algunos addons DataBroker se oculta el icono independientemente de este ajuste."
...
L["Options for PlexusFrame."] = "Opciones para los marcos de Grid"
...
L["Adjust Plexus scale."] = "Ajustar la escala de Grid."
...
L["Allows mouse click through the Plexus Frame."] = "Permiter hacer clic a través de la ventana de Grid."
...
L["Click through the Plexus Frame"] = "Clic a través de Grid"
...
L["Demon"] = "Demonio"
L["Drag this tab to move Plexus."] = "Arrastrar esta pestaña para mover Grid."
...
L["Layouts"] = "Diseños"
L["Left"] = "Izquierda"
L["Lock Plexus to hide this tab."] = "Bloquear Grid para ocultar esta pestaña."
L["Locks/unlocks the Plexus for movement."] = "Bloquear/desbloquear el movimiento de Grid."
L["Not specified"] = "No especificado"
L["Options for PlexusLayout."] = "Opciones para el diseño de Grid."
L["Padding"] = "Relleno"
...
L["Sets where Plexus is anchored relative to the screen."] = "Establecer dónde se ancla grid relativo a la pantalla."
L["Show a tab for dragging when Plexus is unlocked."] = "Muestra la pestaña cuando Grid está desbloqueado."
...
Beginning users may wish to leave this disabled until you are more familiar with Plexus, to avoid being overwhelmed by complicated options menus.]=] ] = [=[Mostrar opciones advanzads para los estados de beneficios y perjuicios.
