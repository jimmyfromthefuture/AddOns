...
L["Options for PlexusFrame."] = "Opções para o QuadroPlexus"
...
L["Adjust Plexus scale."] = "Ajustar escala do Plexus"
--[[Translation missing --]]
...
L["Allows mouse click through the Plexus Frame."] = "Permite clicks do mouse através do quadro do Plexus."
...
L["Click through the Plexus Frame"] = "Clicar através do quadro do Plexus"
...
L["Demon"] = "Demônio"
L["Drag this tab to move Plexus."] = "Arraste essa aba para mover o Plexus."
...
L["Layouts"] = "Layouts"
L["Left"] = "Esquerda"
L["Lock Plexus to hide this tab."] = "Trave o Plexus para ocultar essa aba."
L["Locks/unlocks the Plexus for movement."] = "Trava/Destrava o Plexus para movimento."
L["Not specified"] = "Não especificado"
L["Options for PlexusLayout."] = "Opções para LeiautePlexus."
L["Padding"] = "\"Padding\""
...
L["Sets where Plexus is anchored relative to the screen."] = "Define onde o Plexus estará ancorado em relação a tela."
L["Show a tab for dragging when Plexus is unlocked."] = "Mostre a aba quando o Plexus estiver destravado."
--[[Translation missing --]]
