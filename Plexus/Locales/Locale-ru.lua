...
L["Open Plexus's options in their own window, instead of the Interface Options window, when typing /plexus or right-clicking on the minimap icon, DataBroker icon, or layout tab."] = "После ввода /plexus, нажатия ПКМ на иконке возле мини-карты, иконк DataBroker или открытия вкладки Расположение "
--[[Translation missing --]]
...
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "Отображать иконку Grid возле миникарты. Внимание: некоторые аддоны отображающие сводную информацию могут игнорировать эту настройку."
...
L["Options for PlexusFrame."] = "Опции фреймов Plexus"
...
L["Adjust Plexus scale."] = "Настроиь масштаб Plexus"
...
L["Allows mouse click through the Plexus Frame."] = "Разрешает мышкой кликать сквозь окно Plexus"
...
L["Click through the Plexus Frame"] = "Выбирать через окно Plexus"
...
L["Demon"] = "Демон"
L["Drag this tab to move Plexus."] = "Перетаскивая этот ярлык вы перемстите Plexus."
L["Dragonkin"] = "Дракон"
...
L["Layouts"] = "Макеты"
L["Left"] = "Слева"
L["Lock Plexus to hide this tab."] = "Закрепить Plexus чтобы скрыть данный ярлык."
L["Locks/unlocks the Plexus for movement."] = "Закрепляет/открепляет окно для передвижения"
L["Not specified"] = "Не указано"
L["Options for PlexusLayout."] = "Опции для PlexusLayout"
...
L["Sets where Plexus is anchored relative to the screen."] = "Установить пометку где будет находиться Plexus на экране"
L["Show a tab for dragging when Plexus is unlocked."] = "Отображать ярлык когда Plexus откреплен."
...
Beginning users may wish to leave this disabled until you are more familiar with Plexus, to avoid being overwhelmed by complicated options menus.]=] ] = "Отображать дополнительные настройки бафов и дебафов. Новым игрокам во избежание путаницы в сложных настройках, рекомендуется отключить функцию до освоения Plexus"
