...
L["Show the Plexus icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "Mostra l'icona di Plexus sulla minimappa. Attenzione che alcuni addon DataBroker potrebbero nascondere l'icona ignorando completamente questa impostazione."
--[[Translation missing --]]
...
L["Options for PlexusFrame."] = "Opzioni per i riquadri di Plexus"
...
L["Adjust Plexus scale."] = "Regola la scala di Plexus"
...
L["Allows mouse click through the Plexus Frame."] = "Permetti click del mouse attraverso il riquadro di Plexus."
...
L["Click through the Plexus Frame"] = "Clicca attraverso il riquadro di Plexus"
...
L["Demon"] = "Demone"
L["Drag this tab to move Plexus."] = "Trascina questa linguetta per muovere Plexus."
...
L["Layouts"] = "Layouts"
L["Left"] = "Sinistra"
L["Lock Plexus to hide this tab."] = "Blocca Plexus per nascondere questa linguetta."
L["Locks/unlocks the Plexus for movement."] = "Blocca/sblocca Plexus per permettere di spostarlo."
L["Not specified"] = "Non specificato"
L["Options for PlexusLayout."] = "Opzioni per PlexusLayout"
...
L["Sets where Plexus is anchored relative to the screen."] = "Scegli quando Plexus è ancorato ai bordi dello schermo"
L["Show a tab for dragging when Plexus is unlocked."] = "Mostra una linguetta per il trascinamento quando Plexus non è bloccato."
--[[Translation missing --]]
...
Beginning users may wish to leave this disabled until you are more familiar with Plexus, to avoid being overwhelmed by complicated options menus.]=] ] = [=[Show advanced options for buff and debuff statuses.
