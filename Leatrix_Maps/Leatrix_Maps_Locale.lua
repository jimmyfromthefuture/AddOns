...
L["If checked, group icons on the battlefield map will use a modern, class-colored design."] = "Si está seleccionado, los iconos de grupo en el mapa del campo de batalla usarán un diseño moderno, de color de clase."
...
L["If checked, group icons on the battlefield map will use a modern, class-colored design."] = "Si cette option est cochée, les icônes de groupe sur la carte du champ de bataille utiliseront un design moderne de couleur de classe."
...
L["If checked, group icons on the battlefield map will use a modern, class-colored design."] = "Se marcado, os ícones de grupo no mapa do campo de batalha usarão um design moderno e colorido em classe."
